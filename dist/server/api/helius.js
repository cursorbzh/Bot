 ...
 */
export function initHeliusWebsocket() {
 ...
 */
export function closeHeliusWebsocket() {
    if (wsConnection) {
        wsConnection.close();
        wsConnection = null;
    }
 ...
 */
export function getHeliusConnectionStatus() {
    if (!wsConnection) {
 ...
 */
export async function heliusRpcCall(method, params = []) {
...
export async function getSolanaNetworkStatus() {
    try {
        ...
        const performanceSamples = await heliusRpcCall("getRecentPerformanceSamples", [1]);
...
export async function getTokenAccounts(walletAddress) {
    return heliusRpcCall("getTokenAccountsByOwner", [
        walletAddress,
